...
(function(global2, factory) {
  ...
  */
  ...
  const view = "";
  const text = "";
  const uniCusCalendar_vue_vue_type_style_index_0_scoped_01670485_lang = "";
  ...
  const _sfc_main = {
    ...
    created() {
      ...
      this.extraData = ((_b = (_a2 = this.componentProperties) == null ? void 0 : _a2.data) == null ? void 0 : _b.items) || [];
      this.initColor();
    ...
    methods: {
      initColor() {
        var _a2;
        let { color: color2, dotColor, activeColor } = ((_a2 = this.componentProperties) == null ? void 0 : _a2.style) || {};
        if (dotColor) {
      ...
      toTask(item, index) {
        this.$emit("click-task", { row: item, index });
      },
      selectDay() {
        var _a2, _b, _c, _d;
        ...
        let output = (_b = (_a2 = this.componentProperties) == null ? void 0 : _a2.data) == null ? void 0 : _b.selectDay;
        let month = this.month < 10 ? `0${this.month}` : this.month;
        let day = this.day < 10 ? `0${this.day}` : this.day;
        if (output) {
          (_c = this.store) == null ? void 0 : _c.setVariableValue(
            output,
            this.year + "-" + month + "-" + day
          );
        }
        (_d = this.store) == null ? void 0 : _d.handleAction("change", this);
      },
      LastMonth() {
        if (this.month > 1) {
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createBlock(_component_v_uni_view, { class: "date-box" }, {
      default: vue.withCtx(() => [
        vue.createVNode(_component_v_uni_view, { class: "box-list" }, {
          default: vue.withCtx(() => [
            vue.createVNode(_component_v_uni_view, { class: "date-top" }, {
              default: vue.withCtx(() => [
                vue.createVNode(_component_v_uni_view, {
                  class: "icon left-icon",
                  onClick: $options.LastYear
                }, {
                  default: vue.withCtx(() => [
                    vue.createVNode(_component_v_uni_view, { class: "iconfont icon-jiantou_xiangzuoliangci" })
                  ]),
                  _: 1
                  /* STABLE */
                }, 8, ["onClick"]),
                vue.createVNode(_component_v_uni_view, { class: "conter-text" }, {
                  default: vue.withCtx(() => [
                    vue.createVNode(_component_v_uni_view, {
                      class: "icon left-icon",
                      onClick: $options.LastMonth
                    }, {
                      default: vue.withCtx(() => [
                        vue.createVNode(_component_v_uni_view, { class: "iconfont icon-xiangzuo1" })
                      ]),
                      _: 1
                      /* STABLE */
                    }, 8, ["onClick"]),
                    vue.createVNode(_component_v_uni_text, { class: "month" }, {
                      default: vue.withCtx(() => [
                        vue.createTextVNode(
                    ...
                    vue.createVNode(_component_v_uni_view, {
                      class: "icon rigth-icon",
                      onClick: $options.NextMonth
                    }, {
                      default: vue.withCtx(() => [
                        vue.createVNode(_component_v_uni_view, { class: "iconfont icon-xiangyou1" })
                      ]),
                      _: 1
                      /* STABLE */
                    }, 8, ["onClick"])
                ...
                vue.createVNode(_component_v_uni_view, {
                  class: "icon rigth-icon",
                  onClick: $options.NextYear
                }, {
                  default: vue.withCtx(() => [
                    vue.createVNode(_component_v_uni_view, { class: "iconfont icon-jiantou_xiangyouliangci" })
                  ]),
                  _: 1
                  /* STABLE */
                }, 8, ["onClick"])
            ...
            vue.createVNode(_component_v_uni_view, { class: "date-week" }, {
              default: vue.withCtx(() => [
                (vue.openBlock(true), vue.createElementBlock(
                  vue.Fragment,
                  null,
                  vue.renderList($props.weekList, (item) => {
                    return vue.openBlock(), vue.createBlock(
            ...
            $data.dayList.length > 0 ? (vue.openBlock(), vue.createBlock(_component_v_uni_view, {
              key: 0,
              class: "day-content",
              style: vue.normalizeStyle({ height: $data.isOpen ? "100rpx" : "auto" })
            }, {
              default: vue.withCtx(() => [
                !$data.isOpen ? (vue.openBlock(), vue.createBlock(_component_v_uni_view, {
                  key: 0,
                  class: "day-item day-month"
                }, {
                  default: vue.withCtx(() => [
                    vue.createVNode(_component_v_uni_text, null, {
                      default: vue.withCtx(() => [
                        vue.createTextVNode(
                          vue.toDisplayString($data.month < 10 ? `0${$data.month}` : $data.month),
                          1
                          /* TEXT */
                        )
                      ]),
                ...
                (vue.openBlock(true), vue.createElementBlock(
                  vue.Fragment,
                  null,
                  vue.renderList($data.dayList, (item, index) => {
                    return vue.openBlock(), vue.createBlock(_component_v_uni_view, {
                      class: "day-item",
                      key: index,
                      "data-index": index,
                      onClick: ($event) => $options.toActive(item, index)
                    }, {
                      default: vue.withCtx(() => [
                        item.day ? (vue.openBlock(), vue.createBlock(_component_v_uni_text, {
                          key: 0,
                          class: vue.normalizeClass(["day-text", {
                            actives: item.day === $data.day,
                            current: item.day === $data.now.day && $data.month === $data.now.month && $data.year === $data.now.year
                          }]),
                          style: vue.normalizeStyle({
                            backgroundColor: item.day === $data.day || item.day === $data.now.day && $data.month === $data.now.month && $data.year === $data.now.year ? $data.activeColor : void 0
                          })
                        }, {
                          default: vue.withCtx(() => [
                            vue.createTextVNode(
                              vue.toDisplayString(item.day ? item.day : ""),
                              1
                              /* TEXT */
                            )
                          ]),
                          _: 2
                          /* DYNAMIC */
                        }, 1032, ["class", "style"])) : vue.createCommentVNode("v-if", true),
                        item.data.tip ? (vue.openBlock(), vue.createBlock(_component_v_uni_text, {
                          key: 1,
                          class: "value-text",
                          style: vue.normalizeStyle({ color: item.data.color || $data.color })
                        }, {
                          default: vue.withCtx(() => [
                            vue.createTextVNode(
                              vue.toDisplayString(item.data.tip),
                              1
                              /* TEXT */
                            )
                          ]),
                          _: 2
                          /* DYNAMIC */
                        }, 1032, ["style"])) : vue.createCommentVNode("v-if", true),
                        item.data.dot ? (vue.openBlock(), vue.createBlock(_component_v_uni_text, {
                          key: 2,
                          class: "day-dot",
                          style: vue.normalizeStyle({ backgroundColor: item.data.dotColor || $data.dotColor })
                        }, null, 8, ["style"])) : vue.createCommentVNode("v-if", true)
                      ]),
                      _: 2
                      /* DYNAMIC */
                    }, 1032, ["data-index", "onClick"]);
                  }),
                  128
                  /* KEYED_FRAGMENT */
                ))
            ...
            $props.isShrink ? (vue.openBlock(), vue.createBlock(_component_v_uni_view, {
              key: 1,
              style: { "width": "100%" }
            }, {
              default: vue.withCtx(() => [
                $data.isOpen ? (vue.openBlock(), vue.createBlock(_component_v_uni_view, {
                  key: 0,
                  class: "toggle",
                  onClick: $options.toShrinkClose
                }, {
                  default: vue.withCtx(() => [
                    vue.createVNode(_component_v_uni_view, { class: "iconfont icon-shousuo" })
                  ]),
                  _: 1
                  /* STABLE */
                }, 8, ["onClick"])) : (vue.openBlock(), vue.createBlock(_component_v_uni_view, {
                  key: 1,
                  class: "toggle",
                  onClick: $options.toShrink
                }, {
                  default: vue.withCtx(() => [
                    vue.createVNode(_component_v_uni_view, { class: "iconfont icon-zhankai" })
                  ]),
                  _: 1
                  /* STABLE */
                }, 8, ["onClick"]))
  ...
  const calendar = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-01670485"]]);
